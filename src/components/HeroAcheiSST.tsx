...
const CATEGORIES = [
  { icon: Users,         label: 'Profissionais',  href: '/profissionais',                accent: 'bg-navy-100 text-navy-600' },
  { icon: Stethoscope,   label: 'Clínicas',       href: '/fornecedores?cat=clinica',     accent: 'bg-teal-100 text-teal-700' },
  { icon: ShoppingBag,   label: 'Lojas',          href: '/fornecedores?cat=loja',        accent: 'bg-orange-100 text-orange-700' },
  { icon: Cpu,           label: 'Software',       href: '/fornecedores?cat=software',    accent: 'bg-violet-100 text-violet-700' },
  { icon: BookOpen,      label: 'Revista',        href: '/informativos',                 accent: 'bg-rose-100 text-rose-700' },
  { icon: Mic,           label: 'Podcast',        href: '/conteudo?tipo=podcast',        accent: 'bg-pink-100 text-pink-700' },
  { icon: ScanSearch,    label: 'Peritos',        href: '/profissionais?esp=perito',     accent: 'bg-cyan-100 text-cyan-700' },
  { icon: GraduationCap, label: 'Professores',    href: '/profissionais?esp=professor',  accent: 'bg-indigo-100 text-indigo-700' },
  { icon: PlayCircle,    label: 'Cursos',         href: '/cursos',                       accent: 'bg-sst-100 text-sst-600' },
  { icon: School,        label: 'Escola',         href: '/cursos?tipo=escola',           accent: 'bg-lime-100 text-lime-700' },
  { icon: Building2,     label: 'Faculdade',      href: '/cursos?tipo=faculdade',        accent: 'bg-amber-100 text-amber-700' },
  { icon: HardHat,       label: 'Equipamentos',   href: '/fornecedores?cat=epi',         accent: 'bg-yellow-100 text-yellow-700' },
  { icon: CalendarDays,  label: 'Eventos',        href: '/eventos',                      accent: 'bg-fuchsia-100 text-fuchsia-700' },
  { icon: Briefcase,     label: 'Vagas',          href: '/vagas',                        accent: 'bg-sky-100 text-sky-700' },
  { icon: ClipboardList, label: 'Orçamentos',     href: '/solicitar-orcamento',          accent: 'bg-sst-100 text-sst-600' },
  { icon: Bot,           label: 'Ferramentas IA', href: '/ferramentas',                  accent: 'bg-purple-100 text-purple-700' },
  { icon: Award,         label: 'Treinamentos',   href: '/fornecedores?cat=treinamento', accent: 'bg-red-100 text-red-700' },
  { icon: Newspaper,     label: 'Artigos',        href: '/informativos',                 accent: 'bg-slate-100 text-slate-700' },
]
