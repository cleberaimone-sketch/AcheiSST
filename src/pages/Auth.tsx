      ...
      <div className="flex-1 flex items-center justify-center px-6 pb-12">
        <div className="w-full max-w-md bg-background border border-border rounded-2xl shadow-card p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border border-border rounded-full py-2.5 text-sm font-medium hover:bg-slate-50 transition-colors disabled:opacity-60 mb-4"
          >
            {loadingGoogle
